            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        <h4 class="text-white">A propos de cette page</h4>
                        <p class="text-muted">Exercice de création de site à partir d'une base données : présentation des animaux d'un zoo "WF3 ZOO"</p>
                    </div>
