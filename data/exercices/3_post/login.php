            ...
            <div class="col">
                ...
                <form action="connect.php" method="post" class="form">
                    ...
                    <div class="form-group">
                        ...
                        <input name="getmail" id="formEmail" type="email" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="formpwd">Mot de passe</label>
                        <input name="getpwd" id="formpwd" type="password" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="formRole">Quel rôle ?</label>
